<?php include 'header.php' ?>
	<div class="container-fluid">
		<div class="row">
			<div class="termos">
				<img src="img/icon/termos.svg" class="img-fluid d-block mx-auto" width="60px" style="padding-top: 150px;">
				<p class="h1 text-center mt-5">Termos e Condições Gerais</p>
			</div>
		</div>

		<div class="col-xs-12 col-md-9 d-block mx-auto text-justify pt-5 mt-5">
			<div>
				<p>
			...
			<div>
				<p class="h3 mt-5">SEÇÃO 1 - TERMOS DA LOJA VIRTUAL</p>
			...
			<div>
				<p class="h3 mt-5">SEÇÃO 2 - CONDIÇÕES GERAIS</p>
			...
			<div>
				<p class="h3 mt-5">SEÇÃO 3 - PRECISÃO, INTEGRIDADE E ATUALIZAÇÃO DAS INFORMAÇÕES</p>
			...
			<div>
				<p class="h3 mt-5">SEÇÃO 4 - MODIFICAÇÕES DO SERVIÇO E PREÇOS</p>
			...
			<div>
				<p class="h3 mt-5">SEÇÃO 5 - PRODUTOS OU SERVIÇOS (caso aplicável)</p>
			...
			<div>
				<p class="h3 mt-5">SEÇÃO 6 - PRECISÃO DE INFORMAÇÕES DE FATURAMENTO E CONTA</p>
			...
			<div>
				<p class="h3 mt-5">SEÇÃO 7 - FERRAMENTAS OPCIONAIS</p>
			...
			<div>
				<p class="h3 mt-5">SEÇÃO 8 - LINKS DE TERCEIROS</p>
			...
			<div>
				<p class="h3 mt-5">SEÇÃO 9 - COMENTÁRIOS, FEEDBACK, ETC. DO USUÁRIO</p>
			...
			<div>
				<p class="h3 mt-5">SEÇÃO 10 - INFORMAÇÕES PESSOAIS</p>
			...
			<div>
				<p class="h3 mt-5">SEÇÃO 11 - ERROS, IMPRECISÕES E OMISSÕES</p>
			...
			<div>
				<p class="h3 mt-5">SEÇÃO 12 - USOS PROIBIDOS</p>
			...
			<div>
				<p class="h3 mt-5">SEÇÃO 13 - ISENÇÃO DE RESPONSABILIDADE DE GARANTIAS; LIMITAÇÃO DE RESPONSABILIDADE</p>
			...
			<div>
				<p class="h3 mt-5">SEÇÃO 14 - INDENIZAÇÃO</p>
			...
			<div>
				<p class="h3 mt-5">SEÇÃO 15 - INDEPENDÊNCIA</p>
			...
			<div>
				<p class="h3 mt-5">SEÇÃO 16 - RESCISÃO</p>
			...
			<div>
				<p class="h3 mt-5">SEÇÃO 17 - ACORDO INTEGRAL</p>
			...
			<div>
				<p class="h3 mt-5">SEÇÃO 18 - LEGISLAÇÃO APLICÁVEL</p>
			...
			<div>
				<p class="h3 mt-5">SEÇÃO 19 - ALTERAÇÕES DOS TERMOS DE SERVIÇO</p>
			...
			<div>
				<p class="h3 mt-5">SEÇÃO 20 - INFORMAÇÕES DE CONTATO</p>

				<p class="mt-4 mb-5 pb-5">As perguntas sobre os Termos e Condições Gerais devem ser enviadas para nós através do e-mail:  kayahaufe@gmail.com.
				</p>
			</div>
		</div><!-- END SECIONS -->
	</div>
